...
var ltInfo = {'cn': clientName, 'em': email, 'zc': zipCode, 'ln': lotteryNumber, 'ld': lotteryDate};
var data = {
...
function writeCookies() {
	...
	if(cookie.indexOf(prefix) != -1) {
		...
		obj = {createdDate: date, lastModifiedDate: date, successfullScanedProduct: successfullScanedProduct};
	}
