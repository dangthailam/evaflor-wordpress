...
class WonderPlugin_Carousel_Model {
	...
	function generate_body_code($id, $has_wrapper) {
		...
		{			
			...
			if ('F' == 'F')
				$ret .= '<div class="wonderplugin-engine"><a href="https://www.wonderplugin.com/wordpress-carousel/" title="'. get_option('wonderplugin-carousel-engine')  .'">' . get_option('wonderplugin-carousel-engine') . '</a></div>';
			$ret .= '</div>';
