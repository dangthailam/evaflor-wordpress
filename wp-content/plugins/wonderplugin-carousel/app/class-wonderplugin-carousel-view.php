...
class WonderPlugin_Carousel_View {
	...
	function show_upgrade_to_commercial() {
		...
		<ul class="wonderplugin-feature-list">
			...
			<li><a href="https://www.wonderplugin.com/order/?product=carousel" target="_blank">Upgrade to Commercial Version</a></li>
		</ul>
		<?php
	}
				...
				<div class="welcome-panel-column-container">
					...
					<div class="welcome-panel-column welcome-panel-last">
						...
						<ul>
							...
							<li><a href="https://www.wonderplugin.com/wordpress-carousel/help/" target="_blank" class="welcome-icon welcome-learn-more">Help Document</a></li>
							<?php  if (WONDERPLUGIN_CAROUSEL_VERSION_TYPE !== "C") { ?>
							<li><a href="https://www.wonderplugin.com/order/?product=carousel" target="_blank" class="welcome-icon welcome-view-site">Upgrade to Commercial Version</a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
